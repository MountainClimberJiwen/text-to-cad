...
with open("/Users/jiwen/PycharmProjects/freecad-assembler/models/preview/poc_mesh_data.json") as f:
    meshes = json.load(f)
...
ax.set_axis_off()
plt.savefig("/Users/jiwen/PycharmProjects/freecad-assembler/models/preview/poc_station.png", dpi=150, bbox_inches='tight', facecolor='white')
print("RENDER_OK")
